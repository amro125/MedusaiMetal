...
if __name__ == '__main__':
    ...
    struminput1 = [[[6, 4.7, 4.7, 0, endp[0]], [0.75, 0.25, 2, 1, 5]], [[-27.6, -56.4, -56.4, endp[1]], [1, 1, 2, 5]],
                   [[6, 4.7, 4.7, endp[2]], [0.75, 0.25, 6, 2]], [[118.1, 35.75, 35.75, 100, endp[3]], [1.5, 1, 2, 2.5, 2.5]],
                   [[0, 0, 70, endp[4]], [2, 3, 2, 2]], [[head1, head1, head2, -10, endp[5]], [1, 1.5, 0.125, 3.5+0.875, 2]],
                   [[-20.9, -20.9, endp[6]], [1, 8.5, 0.5]]]
    ...
    struminput2 = [[[6, 4.7, 4.7, 0, endp2[0]], [0.75, 0.25, 2, 1, 5]], [[-27.6, -56.4, -56.4, endp2[1]], [1, 1, 2, 5]],
                   [[6, 4.7, 4.7, endp2[2]], [0.75, 0.25, 6, 2]], [[118.1, 35.75, 35.75, 100, endp2[3]], [1.5, 1, 2, 2.5, 2.5]],
                   [[0, 0, 70, endp2[4]], [2, 3, 2, 2]], [[head1, head1, head2, -10, endp2[5]], [1, 1.5, 0.125, 3.5+0.875, 2]],
